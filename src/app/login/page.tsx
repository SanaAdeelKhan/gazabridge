  ...
  return (
    <div style={{ maxWidth: '480px', margin: '0 auto', padding: '64px 24px' }}>
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        {redirect !== '/dashboard' && (
          <p style={{ color: '#d97706', fontSize: '0.85rem', marginTop: '8px' }}>🔒 Please sign in to continue</p>
        )}
      </div>
      ...
      <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid #fde68a', padding: '32px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <button onClick={handleLogin} disabled={loading} style={{ width: '100%', padding: '14px', borderRadius: '100px', background: '#d97706', color: '#fff', border: 'none', fontWeight: 700, fontSize: '1rem', cursor: 'pointer', fontFamily: 'inherit', opacity: loading ? 0.6 : 1 }}>
