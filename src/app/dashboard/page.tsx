...
export default function DashboardPage() {
  ...
  function toggleEditLang(lang: string) {
    setEditForm(f => ({ ...f, languages: f.languages.includes(lang) ? f.languages.filter(l => l !== lang) : [...f.languages, lang] }))
  }
      ...
      {isGuest && (
        <div style={{ background: 'rgba(192,122,26,0.08)', borderBottom: '1px solid rgba(192,122,26,0.2)', padding: '0.7rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
          <span style={{ fontSize: '0.9rem', color: '#3D3D2E' }}>
            🧭 You&apos;re browsing as a <strong>Guest / Visitor</strong>. Create a profile to connect with volunteers.
          </span>
          <button
            onClick={() => {
            ...
            style={{ background: 'linear-gradient(135deg, #C07A1A, #E09030)', color: '#fff', border: 'none', borderRadius: '50px', padding: '0.4rem 1.1rem', fontSize: '0.85rem', fontWeight: 700, cursor: 'pointer', fontFamily: "'Playfair Display', serif", whiteSpace: 'nowrap' }}>
            Join free →
          </button>
        </div>
      )}
            ...
            <>
              ...
              {isGuest ? (
                <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid #fde68a', padding: '32px', marginBottom: '32px', textAlign: 'center' }}>
                  ...
                  <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.8rem', fontWeight: 700, marginBottom: '8px' }}>Welcome, Guest!</h1>
                  <p style={{ color: '#8A8572', fontSize: '0.95rem', marginBottom: '20px', maxWidth: '420px', margin: '0 auto 20px' }}>
                    You can browse volunteers, courses, and public resources below. Create a profile to connect directly.
                  </p>
                  <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    <button
                      ...
                      style={{ padding: '10px 24px', borderRadius: '100px', background: 'linear-gradient(135deg, #C07A1A, #E09030)', color: '#fff', fontWeight: 600, fontSize: '0.875rem', border: 'none', cursor: 'pointer', fontFamily: 'inherit' }}>
                      ✨ Create My Profile
                    </button>
                  </div>
                </div>
                    ...
                    {showAddOffer && (
                      <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid #fde68a', padding: '28px', marginBottom: '20px' }}>
                        ...
                        <div style={{ marginBottom: '16px' }}>
                          ...
                          <textarea value={offerForm.description} onChange={e => setOfferForm(f => ({ ...f, description: e.target.value }))} style={{ ...inputStyle, minHeight: '100px', resize: 'vertical' as const }} placeholder="Describe what you can offer..." />
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                  ...
                  <div style={{ marginTop: '48px' }}>
                    ...
                    {showAddRequest && (
                      <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid #d1fae5', padding: '28px', marginBottom: '20px' }}>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                          <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, marginBottom: '6px' }}>Description</label>
                          <textarea value={requestForm.description} onChange={e => setRequestForm(f => ({ ...f, description: e.target.value }))} style={{ ...inputStyle, minHeight: '100px', resize: 'vertical' as const, border: '1.5px solid #d1fae5', background: '#f0fdf4' }} placeholder="Describe what you need..." />
                        </div>
